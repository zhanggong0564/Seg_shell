...
class BiSeNet(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        cx1 = torch.nn.functional.interpolate(cx1, size=sp_size, mode='bilinear')
        ...
        if self.training == True:
            ...
            cx2_sup = torch.nn.functional.interpolate(cx2_sup, size=input_size, mode='bilinear')

        result = self.feature_fusion_module(sp, cx)

        result = torch.nn.functional.interpolate(result, size=input_size, mode='bilinear')
